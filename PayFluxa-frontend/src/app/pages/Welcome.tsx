      ...
      <div className="max-w-4xl w-full">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground">
            Enterprise Financial Resilience Platform
          </p>
          <p className="text-sm text-muted-foreground mt-2">
            RBI-Compliant Risk Governance System
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-8">
          ...
          >
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Access your Financial Resilience Dashboard, run loan simulations,
              and get personalized borrowing recommendations
            </p>
          ...
          >
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Enterprise-grade portfolio risk management, restructuring
              workflows, and policy simulation tools
            </p>
            <div className="text-sm text-muted-foreground space-y-1">
        ...
        <div className="mt-12 p-6 bg-white border border-border text-center">
          ...
          <p className="text-sm text-muted-foreground">
            This system is designed in accordance with RBI guidelines for risk
            management and financial resilience assessment. All data is
            encrypted and compliant with banking security standards.
          </p>
        </div>
      </div>
    </div>
